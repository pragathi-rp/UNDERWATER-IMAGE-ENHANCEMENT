...
# Remove the import of imread and imresize from scipy.misc
...
def tiny_hist_old(image_np):
    ...
    # Use OpenCV's resize function instead of imresize
...
#return image_np_lab
def example(path):
    # Use OpenCV's imread function instead of imread from scipy.misc
    img_example = cv2.imread(path).astype('float')/255.0-0.5
